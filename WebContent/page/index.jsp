...
<html>
  <head>
	...
	<link rel="stylesheet" href="common/css/sccl.css" type="text/css">
	<link rel="stylesheet" href="common/skin/qingxin/skin.css" type="text/css">
	...
	<div class="layout-admin">
			...
			<ul class="header-bar">
				...
				<li class="header-bar-nav">
					...
					<ul class="header-dropdown-menu">
						...
						<li><a href="" onclick="e()">切换账户</a></li>
						<li><a href="" onclick="e()">退出</a></li> 
					</ul>
				</li>
				<li class="header-bar-nav"> 
		...
		<section class="layout-main">
			...
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="staff" frameborder="0" data-id="home.html" seamless></iframe>
			</div>
		</section>
